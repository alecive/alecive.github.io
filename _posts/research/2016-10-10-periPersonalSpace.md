...
{% include image.html url="portfolio/PPS-FootballOverRightPalm.jpg" max-width="50%" description="<b><i>Figure 1</i></b>. An object approaching the robot's body (eventually contacting the skin)." %}
...
{% include image.html url="portfolio/PPS-OpticalFlow_FAL_int2.png" max-width="50%" description="<b><i>Figure 2</i></b>. Spatial representation learned from oncoming objects - inner part of left forearm." %}
